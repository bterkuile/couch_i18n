...
feature 'Translations', %q{
  ...
  context 'with records' do
    before :each do
      ...
      @t3 = CouchI18n::Translation.create(translation_key: 'en.prefix.partfinder.suffix', translation_value: 'Other Value', translated: false)
    end
    ...
    context :partfinder do
      scenario 'partfinder should include right results' do
        ...
        page.should_not have_content 'nl.prefix.partfinder_disabled.suffix'
    ...
    context :valuefinder do
      scenario 'value finder should include right results' do
        ...
        page.should have_content 'nl.prefix.partfinder.suffix'
        page.should have_content 'nl.prefix.partfinder_disabled.suffix'
    ...
    context :offset do
      ...
      scenario "should show the proper ones when an offset is given" do
        ...
        page.should have_content 'prefix.partfinder_disabled.suffix'
